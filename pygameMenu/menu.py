...
class Menu(object):
    ...
    def __init__(self, surface, window_width, window_height, font, title,
        ...
        assert isinstance(sound_enable, bool)
        assert isinstance(menu_sound_back, str)
        assert isinstance(menu_sound_ok, str)
        assert isinstance(menu_sound_change, str)
        ...
        # Sounds
        self._sound_enable = sound_enable
        if sound_enable:
            self._menu_sound_change = _pygame.mixer.Sound(menu_sound_change)
            self._menu_sound_ok = _pygame.mixer.Sound(menu_sound_ok)
            self._menu_sound_back = _pygame.mixer.Sound(menu_sound_back)
